...
<body>
    ...
    <div id="content"><!--21starts-->
        <div class="container">
            ...
            <div class="col-md-9">
                <!--which ever variable(my_order,pay_offline) will present in url that only will get inclde in the page-->
                <?php
                ...
                if(isset($_GET['logout'])){
                    echo "<script>alert('Logout successful. You have been signed out.')</script>";
                    include("logout.php");
                }
                ?>
