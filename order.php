    ...
    while($row_cart = mysqli_fetch_array($run_cart)){
        ...
        while($row_pro = mysqli_fetch_array($run_pro)){
            ...
            $insert_customer_order = "insert into customer_order
                                      (customer_id,due_amount,invoice_no,qty,fuel_type,order_date,order_status)
                                      values('$customer_id','$sub_total','$invoice_no','$qty','$fuel_type',NOW(),'$status')";
            ...
            echo "<script>alert('Your Order has been Submitted.<br>Thank You')</script>";
