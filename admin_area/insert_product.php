...
<head>
    ...
    <!-- jQuery library -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script><!--Can be removed-->
...
<?php
    if(isset($_POST['submit'])){
        ...
        if($run_product){
            ...
            echo "<script>window.location.href='insert_product.php'</script>";//"<script>window.open('insert_product.php')</script>";
